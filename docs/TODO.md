...
- [完了] `v0.1.3`のquality gate、Tauri 4環境、CLI 4環境のCRUD smokeと公開側draft uploadがすべて成功した
...
- [完了] 公開済み旧形式のversion付きinstaller名もinstallページから直接取得できるようにした
- [要確認] 現在は公開Releaseが0件のため、Draft公開後にinstallボタンの直接downloadを再確認する
